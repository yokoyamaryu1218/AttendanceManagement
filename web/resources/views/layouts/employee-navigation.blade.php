    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex justify-between h-16">
                ...
                <!-- Navigation Links -->
                <form method="POST" action="{{ route('employee.logout') }}" class="hidden space-x-8 sm:-my-px sm:flex">
                    @csrf
                    <x-nav-link :href="route('employee.logout')" onclick="event.preventDefault();
            ...
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="mt-3 space-y-1">
                    ...
                    <form method="POST" action="{{ route('employee.logout') }}">
                        @csrf
                        <x-responsive-nav-link :href="route('employee.logout')" onclick="event.preventDefault();
                                        this.closest('form').submit();">
                            {{ __('ログアウト') }}
                        </x-responsive-nav-link>
                    </form>
