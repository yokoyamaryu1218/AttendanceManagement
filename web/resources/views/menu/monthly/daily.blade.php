        ...
        <?php for ($i = 1; $i <= $day_count; $i++) : ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" data-bs-toggle="modal" data-bs-target="#inputModal" data-bs-id="{{ $emplo_id }}"data-bs-day="{{ ($ym . '-' . sprintf('%02d', $i)) }}" data-bs-start="{{ $start_time }}" data-bs-closing="{{ $closing_time }}" data-bs-daily="{{ $daily_long }}">
