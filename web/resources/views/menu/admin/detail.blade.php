        ...
        <div class="max-w-2xl mx-auto my-3 bg-gray-100 p-16">
            <form>
                ...
                <div class="flex justify-center">
                    ...
                    <button type="button" class="text-white bg-red-700 hover:bg-red-800 flex mx-auto focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">戻る</button>
                </div>
            </form>
        </div>
        @endforeach
