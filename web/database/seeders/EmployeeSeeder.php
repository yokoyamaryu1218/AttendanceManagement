...
class EmployeeSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $employee_cloumns = 'emplo_id,name,password,management_emplo_id,subord_authority,retirement_authority,created_at,updated_at,deleted_at';
        ...
        $employee_insert_data_list = [
            ...
            ['1004', '部下三郎', '$2y$10$DUOOak6MWz3lJ2.x8A5B2uWTtTFPPDvoenMn2Q3A1i.YHdzbPttx2',  '1001', 0, 0, NULL, NULL, NULL], //パスワード：password
