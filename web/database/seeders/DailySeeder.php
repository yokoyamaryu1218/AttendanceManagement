...
class DailySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $daily_insert_data_list = [
            ...
            ['2', '1001', '2022/06/06', 'ああ', NULL, NULL],
            ['3', '1001', '2022/06/11', 'ああ', NULL, NULL],
            ['4', '1001', '2022/06/16', 'ああ', NULL, NULL],
            ['5', '1001', '2022/06/21', 'ああ', NULL, NULL],
            ['6', '1001', '2022/06/20', 'ああ', NULL, NULL],
        ];
