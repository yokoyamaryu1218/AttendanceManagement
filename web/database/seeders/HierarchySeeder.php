...
class HierarchySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $hierarchy_cloumns = 'id, lower_id, high_id ,created_at,updated_at';
        //@var string カラム列のホルダー
        $hierarchy_holder = '?,?,?,?,?';
        // @var array employeeの挿入データ
        $hierarchy_insert_data_list = [
            ['1', '1000', '0000', NULL, NULL],
            ['2', '1001', '1000', NULL, NULL],
            ['3', '1002', '1001', NULL, NULL],
            ['4', '1003', '1001', NULL, NULL],
            ['5', '1004', '1001', NULL, NULL],
        ];
